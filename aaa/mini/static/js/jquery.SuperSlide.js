(function(a) {
    a.fn.slide = function(b) {
        return a.fn.slide.defaults = {
            ...
            triggerTime: 150,
            defaultIndex: 0,
            titCell: ".diskboot-flowTit li",
            mainCell: ".diskboot-flowTit",
            targetCell: null,
            trigger: "mouseover",
            scroll: 1,
            vis: 1,
                    ...
                    J = function(a) {
                        if (D != n || a || "leftMarquee" == d || "topMarquee" == d) {
                            ...
                            for(var i = 0 ;i < h.length ; i++){
                                if(i <= n){
                                    h.eq(i).addClass(c.titOnClassName)
                                }else{
                                    h.eq(i).removeClass(c.titOnClassName)
                                }
                            }
                           // h.eq(n).addClass(c.titOnClassName),

...
(function($){
    ...
    $.fn.supersized = function() {
        ...
        //Set current image
        if(options.slides[$.currentSlide]!=null){
        ...
        //Set next image
        if(options.slides[$.currentSlide + 1]!=null){
        ...
        $(window).bind("load", function(){
            ...
            if (options.thumbnail_navigation == 1){
                ...
                if(options.slides[prevThumb]!=null)
                ...
                if(options.slides[nextThumb]!=null)
            ...
            if (options.slideshow == 1){
                ...
                if (options.navigation == 1){ //Skip if no navigation
                    ...
                    $('#nextslide').mousedown(function() {
                        $(this).attr("src", "/static/js/imageplay/images/forward.png");
                    });
                    $('#nextslide').mouseup(function() {
                        $(this).attr("src", "/static/js/imageplay/images/forward_dull.png");
                    });
                    ...
                    $('#prevslide').mousedown(function() {
                        $(this).attr("src", "/static/js/imageplay/images/back.png");
                    });
                    $('#prevslide').mouseup(function() {
                        $(this).attr("src", "/static/js/imageplay/images/back_dull.png");
                    });
                    ...
                    $('#pauseplay').click(function() {
                        if($.inAnimation) return false;
                        var src = ($(this).attr("src") === "/static/js/imageplay/images/play.png") ? "/static/js/imageplay/images/pause.png" : "/static/js/imageplay/images/play.png";
                        if (src == "/static/js/imageplay/images/pause.png"){
                            $(this).attr("src", "/static/js/imageplay/images/play.png");
                            $.paused = false;
                            slideshow_interval = setInterval(nextslide, options.slide_interval);
                        }else{
                            $(this).attr("src", "/static/js/imageplay/images/pause.png");
                            clearInterval(slideshow_interval);
                            $.paused = true;
                        }
                        $(this).attr("src", src);
                    ...
                    $('#pauseplay').mouseover(function() {
                        var imagecheck = ($(this).attr("src") === "/static/js/imageplay/images/play_dull.png");
                        if (imagecheck){
                            $(this).attr("src", "/static/js/imageplay/images/play.png");
                        }else{
                            $(this).attr("src", "/static/js/imageplay/images/pause.png");
                    ...
                    $('#pauseplay').mouseout(function() {
                        var imagecheck = ($(this).attr("src") === "/static/js/imageplay/images/play.png");
                        if (imagecheck){
                            $(this).attr("src", "/static/js/imageplay/images/play_dull.png");
                        }else{
                            $(this).attr("src", "/static/js/imageplay/images/pause_dull.png");
                        }
                        return false;
                    });
                }
        ...
        $('#supersized').hover(function() {
            if (options.slideshow == 1 && options.pause_hover == 1){
                if(!($.paused) && options.navigation == 1){
                    $('#pauseplay').attr("src", "/static/js/imageplay/images/pause.png");
                    clearInterval(slideshow_interval);
                }
            }
            ...
            if (options.slideshow == 1 && options.pause_hover == 1){
                if(!($.paused) && options.navigation == 1){
                    $('#pauseplay').attr("src", "/static/js/imageplay/images/pause_dull.png");
                    slideshow_interval = setInterval(nextslide, options.slide_interval);
                }
            }
